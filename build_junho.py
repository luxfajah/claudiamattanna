...
# Basic replacements
html = html.replace('Juliana Ximendes', 'Claudia Mattanna')
html = html.replace('juximendes', 'claudiamattanna')
html = html.replace('style.css?v=2.2', 'junho.css?v=2.2')
html = html.replace('script.js', 'junho.js')
html = html.replace('logos/Foto de perfil.jpg', 'foto.jpg')
html = html.replace('0 de 6 aprovados', '0 de 3 aprovados')
html = html.replace('6 posts', '3 posts')
...
html = html.replace('6 posts estratégicos', '3 posts estratégicos')
html = html.replace('id="f-pending">6<', 'id="f-pending">3<')

# Profile Bio
html = html.replace('Juliana Ximendes | Consultoria em Carreira', 'Claudia Mattanna | Ginecologia Endócrina')
...
html = html.replace('🔗 linktr.ee/juximendes e mais 1', '🔗 linktr.ee/claudiamattanna')
